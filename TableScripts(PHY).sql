...
BEGIN
    FOR N IN 1..6
    LOOP
        INSERT INTO BOARD VALUES(SEQ_QNABOARD_NO.NEXTVAL, 1, '게시글 ' || SEQ_QNABOARD_NO.CURRVAL , '이 게시글은 영국에서 시작해서..' ||  SEQ_BOARD_NO.CURRVAL, null, null, DEFAULT, 'Y', SYSDATE, SYSDATE, DEFAULT, 'Y');
    END LOOP;
