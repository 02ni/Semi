...
CREATE SEQUENCE SEQ_P_OPTION;

COMMIT;

-------------------------옵션용 insert 구문-----------------
INSERT INTO P_OPTION(OPT_NO,OPT_NAME,OPT_PRICE) VALUES(SEQ_P_OPTION.NEXTVAL,'락카',10000);
INSERT INTO P_OPTION(OPT_NO,OPT_NAME,OPT_PRICE) VALUES(SEQ_P_OPTION.NEXTVAL,'헬스',5000);
...
COMMENT ON COLUMN VOUCHER.VOUCHER_NO IS '이용권종류번호';
COMMENT ON COLUMN VOUCHER.CATE IS '이용권 카테고리';
COMMENT ON COLUMN VOUCHER.PRICE IS '이용권 가격';
COMMENT ON COLUMN VOUCHER.GYM_NO IS '센터번호';
